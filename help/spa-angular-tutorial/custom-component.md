...
5. Aktualisieren Sie die statische Variable `RESOURCE_TYPE`, um auf die AEM Komponente `wknd-spa-angular/components/custom-component` zu verweisen, die in der vorherigen Übung erstellt wurde.
