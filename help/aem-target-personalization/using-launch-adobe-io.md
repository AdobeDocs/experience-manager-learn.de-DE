...
description: Schrittweise Anleitung zur Integration von Adobe Experience Manager mit Adobe Target mithilfe von Experience Platform Launch- und Adobe-E/A
seo-description: Schrittweise Anleitung zur Integration von Adobe Experience Manager mit Adobe Target mithilfe von Experience Platform Launch- und Adobe-E/A
...
# Verwenden von Adobe Experience Platform Launch über Adobe-E/A-Konsole

## Voraussetzungen

* [AEM Autoreninstanz](./implementation.md#set-up-aem) und Veröffentlichungsinstanz, die auf localhost Port 4502 bzw. 4503 ausgeführt wird
* **Experience Cloud**
...
3. Klicken Sie im Umschalter auf **Starten** und klicken Sie dann auf **Los** .
...
4. Vergewissern Sie sich, dass Sie sich in der richtigen Organisation befinden, und fahren Sie dann mit dem Erstellen einer Launch-Eigenschaft fort.
   ...
   *Weitere Informationen zum Erstellen von Eigenschaften finden Sie unter Eigenschaft[erstellen](https://docs.adobelaunch.com/administration/companies-and-properties#create-a-property)in der Produktdokumentation.*
...
7. Geben Sie als Domäne *localhost.com* ein, da diese Domäne die Domäne ist, auf der die WKND-Demo-Site ausgeführt wird. Obwohl das Feld &quot;*Domäne*&quot;erforderlich ist, funktioniert die Eigenschaft &quot;Start&quot;in jeder Domäne, in der es implementiert ist. Primär dient dieses Feld dazu, Menüoptionen im Rule Builder vorauszufüllen.
...
Die Adobe Target-Erweiterung unterstützt clientseitige Implementierungen mit der Zielgruppe JavaScript SDK für das moderne Web `at.js`. Kunden, die weiterhin Zielgruppe ältere Bibliotheken verwenden, `mbox.js`sollten ein Upgrade auf at.js [](https://docs.adobe.com/content/help/en/target/using/implement-target/client-side/upgrading-from-atjs-1x-to-atjs-20.html) durchführen, um Launch zu verwenden.
...
2. Klicken Sie auf die Option &quot; **Erweiterungskatalog** &quot;und suchen Sie im Filter nach Zielgruppen.
3. Wählen Sie die neueste Version von Adobe Target at.js und klicken Sie auf die Option **Installieren** .
...
1. Klicken Sie für Ihre Site-Eigenschaft auf die Registerkarte **Veröffentlichung** , und erstellen Sie eine Bibliothek zum Erstellen und Bereitstellen Ihrer Änderungen (Datenelemente, Regeln) in einer Entwicklungs-Umgebung.
   >[!VIDEO](https://video.tv.adobe.com/v/28412?quality=12&learn=on)
2. Veröffentlichen Sie Ihre Änderungen aus der Entwicklungsumgebung in einer Staging-Umgebung.
   >[!VIDEO](https://video.tv.adobe.com/v/28419?quality=12&learn=on)
3. Führen Sie die Option &quot; **Erstellen für Staging&quot;aus**.
4. Nachdem die Erstellung abgeschlossen ist, führen Sie **Genehmigung zur Veröffentlichung**aus, wodurch Ihre Änderungen von einer Staging-Umgebung in eine Produktions-Umgebung verschoben werden.
   ![Staging to Production](assets/using-launch-adobe-io/build-staging.png)
5. Führen Sie schließlich die Option &quot; **Erstellen und Veröffentlichen in Produktion** &quot;aus, um Ihre Änderungen in die Produktion zu verschieben.
...
>[!NOTE]
>
> Gewähren Sie der Adobe-E/A-Integration Zugriff auf ausgewählte Arbeitsbereiche mit der entsprechenden [Rolle, damit ein zentrales Team nur in wenigen Arbeitsbereichen](https://docs.adobe.com/content/help/en/target/using/administer/manage-users/enterprise/configure-adobe-io-integration.html)API-gesteuerte Änderungen vornehmen kann.

1. Erstellen Sie die IMS-Integration in AEM mit den Anmeldeinformationen der Adobe I/O. (01:12 bis 03:55)
2. Erstellen Sie in Experience Platform Launch eine Eigenschaft. ( [oben](#create-launch-property)behandelt)
...
Zu diesem Zeitpunkt haben Sie [AEM mit Adobe Target erfolgreich integriert, indem Sie Adobe Experience Platform Launch](./using-aem-cloud-services.md#integrating-aem-target-options) verwenden, wie in Option 1 beschrieben.
