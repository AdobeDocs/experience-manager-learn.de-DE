...
3. Nachdem Sie Erlebnisfragment von AEM nach Adobe Target als Angebote exportiert haben, können Marketingexperten mithilfe dieser Angebot eine Aktivität in der Zielgruppe erstellen. Auf der Grundlage der SkateFest-Kampagne auf der WKND-Site muss der Marketingspezialist ein personalisiertes Erlebnis erstellen und den WKND-Site-Besuchern aus jedem Bundesstaat ein personalisiertes Erlebnis bereitstellen. Um eine Erlebnis-Targeting-Aktivität zu erstellen, muss der Marketingspezialist die Audiencen identifizieren. Für unsere WKND SkateFest-Kampagne müssen wir 50 separate Audiencen erstellen, je nach ihrem Standort, von dem aus sie die WKND-Website besuchen.
...
3. Klicken Sie im Lösungsumschalter auf **Zielgruppe** und **starten** Sie Adobe Target.
...
5. Klicken Sie im Hauptnavigationsmenü auf **Audiencen**.
...
6. Um eine Audience zu erstellen, klicken Sie auf &quot;Audience **** erstellen&quot;und geben Sie einen Namen für die Audience ein.
...
8. Klicken Sie auf **Auswählen** und wählen Sie eine der folgenden Optionen aus:
   * Land
...
9. Wählen Sie den Operator als **Übereinstimmung** aus und geben Sie einen entsprechenden Wert ein (z. B.: Kalifornien) und **Speichern** Sie Ihre Änderungen. Geben Sie in unserem Fall den Statusnamen ein.
...
10. Wiederholen Sie die Schritte 6 bis 9, um Audiencen für die anderen Status zu erstellen.
...
2. Klicken Sie auf Aktivität **** erstellen und wählen Sie den Aktivitäten-Typ **Erlebnis-Targeting** .
...
7. Um eine Audience zu Ihrem VEC hinzuzufügen, klicken Sie unter &quot;Audiencen&quot;auf **Hinzufügen Erlebnis-Targeting** , wählen Sie die WKND-California-Audience und klicken Sie auf **Weiter**.
   ![VEC](assets/personalization-use-case-1/vec-select-audience.png)
8. Klicken Sie auf die WKND-Site innerhalb von VEC, wählen Sie das HTML-Element aus, um das Angebot für die WKND-California-Audience hinzuzufügen, und wählen Sie die Option **Ersetzen durch** und wählen Sie dann das **HTML-Angebot**aus.
   ![Erlebnis-Targeting-Aktivität](assets/personalization-use-case-1/vec-selecting-div.png)
9. Wählen Sie das **WKND SkateFest California** HTML-Angebot für die **WKND-California** -Audience aus, wählen Sie die Benutzeroberfläche aus und klicken Sie auf **Fertig**.
10. Sie sollten nun das **WKND SkateFest California** HTML-Angebot sehen können, das zu Ihrer WKND-Site-Seite für die WKND-California Audience hinzugefügt wurde.
...
12. Klicken Sie auf **Weiter** , um fortzufahren, und Sie können eine Zuordnung für Audiencen zu Erlebnissen sehen.
13. Klicken Sie auf **Weiter** , um zu Ziele und Einstellungen zu wechseln.
14. Wählen Sie die Quelle des Berichte und ein Hauptziel für Ihre Aktivität aus. Wählen Sie für unser Szenario die Berichte-Quelle als **Adobe Target** aus, messen Sie die Aktivität als **Konversion**, zeigen Sie die angezeigte Seite an und zeigen Sie die URL auf die Seite &quot;WKND-SkateFest-Details&quot;.
...
15. Bewegen Sie den Mauszeiger über den Namen der aktuellen Aktivität, und Sie können ihn in **WKND SkateFest - USA** umbenennen und dann Ihre Änderungen **speichern und schließen** .
16. Achten Sie im Bildschirm &quot;Aktivität&quot; darauf, Ihre Aktivität zu **aktivieren** .
   ![Aktivität aktivieren](assets/personalization-use-case-1/activate-activity.png)
17. Ihre WKND SkateFest Kampagne ist jetzt live für alle WKND Site Besucher.
18. Navigieren Sie zur [WKND Site-Startseite](http://localhost:4503/content/wknd/en.html)und Sie sollten das WKND SkateFest-Angebot sehen können, das auf Ihrem Geo-Standort basiert (*Bundesstaat: Kalifornien*).
...
2. Navigieren Sie zur [WKND-Site-Startseite](http://localhost:4503/content/wknd/en.html), und Sie sollten das WKND SkateFest-Angebot sehen können, basierend auf Ihrer geografischen Lage (Bundesstaat).
3. Sehen Sie sich das folgende Video an, um zu verstehen, wie ein Angebot an Ihre Seite gesendet wird, wie Sie Antworttokens anpassen und eine Qualitätsprüfung durchführen können.
