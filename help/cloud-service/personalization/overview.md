...
## Live-Demo von Personalization-Anwendungsfällen

Erleben Sie die Personalisierung in Aktion auf der [WKND-Website](https://wknd.enablementadobe.com/de/de.html){target="_blank"}. Auf der Demo-Site werden drei Arten der Personalisierung veranschaulicht: A/B-Tests, Verhaltens-Targeting und Personalisierung für bekannte Benutzende.
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./live-demo.md" title="Live-Demo von Personalization-Anwendungsfällen" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/live-demo/live-demo.png" alt="Live-Demo von Personalization-Anwendungsfällen"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./live-demo.md" target="_self" rel="referrer" title="Live-Demo von Personalization-Anwendungsfällen">Live-Demo von Personalization-Anwendungsfällen</a>
                    </p>
                    <p class="is-size-6">Erleben Sie die Personalisierung in Aktion auf der WKND-Aktivierungs-Website. Auf der Demo-Site werden drei Arten der Personalisierung veranschaulicht: A/B-Tests, Verhaltens-Targeting und Personalisierung für bekannte Benutzende.</p>
                </div>
