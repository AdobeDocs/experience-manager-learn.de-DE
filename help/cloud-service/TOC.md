...
+ AEM-APIs{#aem-apis}
   ...
   + [OpenAPI-basierte AEM-APIs (Server-zu-Server)](./apis/invoke-openapi-based-aem-apis.md)
   + [OpenAPI-basierte AEM-APIs (benutzerauthentifiziert)](./apis/invoke-openapi-based-aem-apis-from-web-app.md)
