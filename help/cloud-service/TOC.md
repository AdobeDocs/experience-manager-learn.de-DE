...
+ Einführung in AEM as a Cloud Service{#introduction}
   ...
   + Strategie- und Gedankenführerschaft{#strategy}
      ...
      + [Beschleunigung von Inhalten mit Adobe Experience Manager](./introduction/drive-content-velocity-for-sites.md)
   ...
   + Erweiterbarkeit{#extensibility}
      + Inhaltsfragmentkonsole{#content-fragments}
         ...
         + Beispielerweiterungen{#example-extensions}
            ...
            + [Generieren und Hochladen von Bildern in AEM](./developing/extensibility/content-fragments/example-extensions/image-generation-and-image-upload.md)
...
+ Inhaltsbereitstellung{#content-delivery}
   + [URL-Umleitungen](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/administration/url-redirection.html)
...
+ Migration {#migration}
   ...
   + Wechseln zu AEM as a Cloud Service {#moving-to-aem-as-a-cloud-service}
      ...
      + Inhaltsmigration {#content-migration}
         ...
         + [Häufig gestellte Fragen (FAQ)](./migration/moving-to-aem-as-a-cloud-service/content-migration/faq.md)
...
+ Formulare{#forms}
   ...
   + Acrobat Sign mit AEM Forms{#forms-and-sign}
      ...
      + [Acrobat Sign Cloud-Konfiguration](./forms/forms-and-sign/create-adobe-sign-cloud-configuration.md)
