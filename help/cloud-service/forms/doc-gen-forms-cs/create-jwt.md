---
title: JSON-Web-Token (JWT) erstellen
...
Die Dienstanmeldeinformationen, die Sie im vorherigen Schritt heruntergeladen haben, enthalten den privaten Schlüssel im PKCS#1-Format. Um den privaten Schlüssel aus dieser Zeichenfolge zu extrahieren, haben wir die Bibliotheken [BouncyCastle](https://www.bouncycastle.org/) verwendet. Die Kryptobibliotheken, die Teil von Java sind, unterstützen das PKCS#1-Format nicht.
