...
>[!TIP]
>
>Wann immer ein Cookie gesetzt wird (z. B. Set-Cookie: x-aem-variant=NY) sollte die Antwort nicht zwischenspeicherbar sein (sollte Cache-Control haben): private oder Cache-Control: no-cache)
