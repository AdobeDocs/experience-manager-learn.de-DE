...
<div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Custom fields">
    <div class="card" style="height: 100%">
      ...
      <div class="card-content is-padded-small">
        <div class="content">
          <p class="headline is-size-6 has-text-weight-bold"><a href="./examples/editor-custom-field.md" title="Benutzerdefinierte Felder">Benutzerdefinierte Felder</a></p>
          <p class="is-size-6">Erstellen Sie benutzerdefinierte Inhaltsfragmentfelder.</p>
