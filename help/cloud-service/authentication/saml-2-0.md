...
### Unterstützung durch den AEM as a Cloud Service Preview Service
...
## Benutzerdefinierte SAML-Anmelde-Hooks

Für komplexere Anwendungsfälle unterstützt AEM die Entwicklung benutzerdefinierter SAML-Anmelde-Hooks, bei denen es sich um OSGi-Services handelt, die die `com.adobe.granite.auth.saml.SamlLoginHook` implementieren. Diese Erweiterungspunkte werden während des SAML-Authentifizierungsprozesses ausgeführt und können zur Implementierung benutzerdefinierter Logik verwendet werden, z. B. für zusätzliche Benutzerbereitstellung oder benutzerdefinierte Protokollierung.

Weitere Informationen zum Entwickeln und Registrieren eines benutzerdefinierten SAML-Anmelde-Hooks finden Sie in der Dokumentation [Custom SAML Login Hook](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/custom-saml-login-hook.html).
