...
*Die folgenden Kapitellinks gehen von der Annahme aus, dass [Anfängliche Pakete](#initialpackages) werden auf der AEM-Autoreninstanz unter`http://localhost:4502`*
...
1. **Wie kann ich die Neuindizierung stoppen?**
   ...
   Die Neuindizierung kann über das MBean IndexStats gestoppt werden, das über verfügbar ist. [AEM Web-Konsole > JMX](http://localhost:4502/system/console/jmx)

   * [http://localhost:4502/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats](http://localhost:4502/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats)
      * Ausführen `abortAndPause()` , um die Neuindizierung abzubrechen. Dadurch wird der Index für eine weitere Neuindizierung gesperrt, bis `resume()` aufgerufen wird.
      * Wird ausgeführt `resume()` startet den Indizierungsprozess neu.
