...
***✔<sup>+</sup> wichtige Verbesserungen an der Funktion in dieser Version.***
...
***✔weist darauf hin, dass die Funktion in dieser Version erheblich verbessert wurde.***

***✔<sup>+</sup> kennzeichnet die Funktion, die über ein Service Pack oder Feature Pack verfügbar ist.***
...
Vorkonfigurierte Workflows und Aufgaben zur Überprüfung und Genehmigung digitaler Assets unter Verwendung von AEM-Projekten.</td>
 ...
 Automatische Übersetzungsunterstützung von Asset-Metadaten mit Sprachstämmen.</td>
        ...
        <tr>
            ...
            Nutzen Sie die Adobe-KI, um Bilder automatisch mit nützlichen Metadaten zu kennzeichnen.</td>
            <td> </td>
            <td></td>
            <td> </td>
            <td> </td>
