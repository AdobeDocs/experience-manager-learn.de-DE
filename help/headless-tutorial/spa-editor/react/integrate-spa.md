...
Herzlichen Glückwunsch, Sie haben die SPA aktualisiert und die Integration mit AEM untersucht! Sie wissen jetzt, wie Sie die SPA mit der AEM JSON-Modell-API mithilfe einer **webpack-dev-server**.
