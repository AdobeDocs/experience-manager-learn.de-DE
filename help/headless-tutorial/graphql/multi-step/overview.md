...
Der Quell-Code und die Inhaltspakete sind im `basic-tutorial` im GitHub-Projekt [AEM Guides - WKND GraphQL verfügbar](https://github.com/adobe/aem-guides-wknd-graphql/tree/main/basic-tutorial).
