---
title: Filtern der ExpressJS- und Pug-App
description: Eine einfache ExpressJS/Pug-App, die WKND-Abenteuer filtert, die mit Inhaltsfragmenten modelliert wurden.
...
# Filtern der ExpressJS- und Pug-App

Erkunden Sie AEM Headless-GraphQL-APIs, mit denen Daten mithilfe eines [ExpressJS](https://expressjs.com/)/[Pug](https://pugjs.org/) App. Diese ExpressJS-/Pug-App erstellt eine Liste der WKND-Abenteuer, die nach Aktivitätstyp gefiltert werden können.
