---
title: Auflösen von Bildpfaden für AEM GraphQL
description: null
...
| Client | Teilen von Domänen mit AEM | Separate Domäne von AEM | Keine Domäne (z. B. Mobil, serverseitig) |
|----------------------------:|:-----------------------:|:------------------------:|:-----------------------------------:|
| Erfordert Ressourcenpfad | ✘ | ms | ms |
