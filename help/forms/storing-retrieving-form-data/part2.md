...
# Servlet zum Speichern von Formulardaten erstellen

Im nächsten Schritt erstellen Sie ein Servlet, das entweder Formulardaten einfügen oder aktualisieren soll. Die im vorherigen Schritt konfigurierte Datenquelle für die Apache Sling Connection-Pool-Verbindung wird in Zeile 26 referenziert. Der Rest des Codes ist ziemlich einfach. Der Code fügt entweder eine neue Zeile in die Datenbank ein oder aktualisiert eine vorhandene Zeile. Gespeicherte adaptive Formulardaten sind mit einer GUID verknüpft. Die gleiche GUID wird dann verwendet, um die Formulardaten zu aktualisieren.
