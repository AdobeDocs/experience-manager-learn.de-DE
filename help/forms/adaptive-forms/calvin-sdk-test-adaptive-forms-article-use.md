...
Calvin SDK ist eine Dienstprogramm-API für Entwickler von adaptiven Formularen zum Testen von adaptiven Formularen. Calvin SDK is built on top of the [Hobbes.js testing framework](https://docs.adobe.com/docs/de/aem/6-3/develop/ref/test-api/index.html). Calvin SDK ist ab AEM Forms 6.3 verfügbar.
...
* Verwenden Sie zum Hinzufügen einer Testschreibweise zur Testsuite die `addTestCase` Methode des TestSuite-Objekts.
...
* Aktionen, einschließlich `navigateTo``asserts.isTrue` , können dem Testfall als Aktionen hinzugefügt werden.
...
## Testsuiten ausprobieren {#try-out-the-sample-test-suites}
