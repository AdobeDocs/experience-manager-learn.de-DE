---
title: OSGi-Konfiguration erstellen
description: Geben Sie die Azure Portal-Konfigurationseinstellungen mithilfe der OSGi-Konfiguration an.
...
[Vorbefüllungs-Dienst schreiben](./create-prefill-service.md)
